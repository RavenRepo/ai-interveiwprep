...
// Video constraints
export const MAX_VIDEO_SIZE_MB = Number(process.env.REACT_APP_MAX_VIDEO_SIZE_MB) || 50;
export const MAX_VIDEO_SIZE_BYTES = MAX_VIDEO_SIZE_MB * 1024 * 1024;
export const MAX_RECORDING_DURATION = Number(process.env.REACT_APP_MAX_RECORDING_DURATION) || 180; // seconds
